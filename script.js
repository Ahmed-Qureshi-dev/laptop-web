...
const statsObs = new IntersectionObserver(es => {
  if (es[0].isIntersecting) {
    animNum(document.getElementById('s1'), 12000, '+');
    animNum(document.getElementById('s2'), 80, '+');
    animNum(document.getElementById('s3'), 10000, '+');
    statsObs.disconnect();
  }
}, { threshold: 0.3 });
statsObs.observe(document.querySelector('.hero-stats-new'));
